	...
	'toolbars'		: {
		'mathematical' : {
			...
			'buttons' 	: [
                            ...
                            { "value" : "ISFRACTION",   	"code" : "ISFRACTION(",   	"tip" : "ISFRACTION(x) returns true if x has fraction format.<br> <strong>ISFRACTION(4) = false</strong><br> <strong>ISFRACTION(&quot;2/5&quot;) = true</strong>" },
                            { "value" : "SIMPLIFYFRACTION",   	"code" : "SIMPLIFYFRACTION(",   	"tip" : "Simplifies fractional number passed by parameter, returning the result as an interger or fractional number.<br><strong>SIMPLIFYFRACTION(&quot;2/4&quot;)</strong> returns <strong>&quot;1/2&quot;</strong><br>SIMPLIFYFRACTION accepts two integer numbers as parameters and return a simplified fractional number or an integer.<br><strong>SIMPLIFYFRACTION(2, 4)</strong> returns <strong>&quot;1/2&quot;</strong>" },
		...
		'logical' : {
			...
			'buttons' 	: [
							...
							{ "value" : "CFFCOUNTIF", 		"code" : "CFFCOUNTIF(", 	"tip" : "<p>Counts the elements of the array that are equal to the term. <strong>CFFCOUNTIF(array, term)</strong></p><p>E.g. <strong>CFFCOUNTIF([5,10,5,7], 5)</strong><br>returns <strong>2</strong></p><p>The term can be a callback function that returns a boolean.</p><p>E.g. CFFCOUNTIF([5,10,5,7], <strong>function(x){ return x == 5;}</strong>)</p>" },
							{ "value" : "CFFFILTER", 		"code" : "CFFFILTER(", 	"tip" : "<p>Returns the subset of elements in the array that satisfies the callback. The callback function receives a parameter and returns a boolean. <strong>CFFFILTER(array, callback)</strong></p><p>E.g. <strong>CFFFILTER([5,10,5,7], function(x){ return 5 < x;})</strong><br>returns <strong>[10,7]</strong></p>" }
						]
		},
